...
Read {WS}/i_screen.json and {WS}/packet.json. For each candidate write one thesis with a claim
that could be proven wrong, and name the observation that would falsify it.
Write {WS}/i_thesis.json exactly:
{"stage":"thesis","theses":[{"symbol":"...","claim":"<one sentence>",
 "falsified_if":"<one observation>","refs":["EV-..."]}]}
