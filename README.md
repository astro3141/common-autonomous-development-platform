...
cadp/tests/conformance/  deterministic conformance suites (C*/P*/FC*/WB* controls)
                    with their traceability manifest — gate-protected
cadp/tests/ops/     operational-contract suites (T* budgets, argv/prompt shapes)
