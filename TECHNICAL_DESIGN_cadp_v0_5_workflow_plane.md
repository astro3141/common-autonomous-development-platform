...
| `CANDIDATE_PROVENANCE` as ordinary evidence; independence vs actual producer | Spec v0.5 §2.5, §4.5; TD v0.4 §9.1 (ingress discipline, no promoted self-report) |
