...
cadp/tests/conformance/  TD-mandated conformance suites (C*/P*/A*/FC*/WB* controls),
                    the traceability manifest and its meta-test — gate-protected
cadp/tests/ops/     operational-contract suites (argv snapshots, prompt shapes,
                    timeout budgets) — run by every verifier, not gate-protected
